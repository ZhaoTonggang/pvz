var CPlants = NewO({
		...
		CanGrow: function(c, b, e) {
			var a = b + "_" + e,
				d = oS.ArP;
			return d ? oGd.$LF[b] == 1 ? (e > 0 && e < d.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || c[
				1])) : c[0] && !c[1] : oGd.$LF[b] == 1 ? !(e < 1 || e > 9 || oGd.$Crater[a] || oGd
				.$Tombstones[a] || c[1]) : c[0] && !c[1]
		},
		...
		Birth: function(d, c, h, a, m, n) {
			...
			e.opacity = 1;
			e.InitTrigger(e, b, e.R = h, e.C = a, e.AttackedLX = k + e.beAttackedPointL, e.AttackedRX = k + e
				.beAttackedPointR);
			$P[b] = e;
			$P.length += 1;
			e.BirthStyle(e, b, f, {
	...
	oGraveBuster = InheritO(CPlants, {
		...
		BookHandBack: 2.5,
		canEat: 0,
		PicArr: ["images/Card/Plants/GraveBuster.png", "images/Plants/GraveBuster/GraveBuster.gif",
			"images/Plants/GraveBuster/GraveBuster.gif" + $Random + Math.random()
		],
		AudioArr: ["gravebusterchomp"],
		CanGrow: function(b, a, d) {
			var c = oS.ArP;
			return c ? d > 0 && d < c.ArC[1] && (a + "_" + d in oGd.$Tombstones && !b[1]) : a + "_" + d in oGd
				.$Tombstones && !b[1]
		},
		getShadow: function(a) {
		...
		PrivateBirth: function(a) {
			...
			oSym.addTask(420, function(b) {
				var e = $P[b],
					c, d, f;
				e && (d = e.R, f = e.C,
					delete oGd.$Tombstones[c = d + "_" + f], e.Die(), ClearChild($("dTombstones" +
						c)), oS.StaticCard && AppearSun(Math.floor(GetX(f) + Math.random() * 41),
						GetY(d), 25, 0))
	...
	oLawnCleaner = InheritO(CPlants, {
		...
		NormalAttack: function(a) {
			...
			(function(b, c, k, j, e, g) {
				...
				k > c ? b.Die() : (b.pixelRight += 10, b.AttackedLX = k += 10, b.AttackedRX = j += 10, g
					.style.left = (b.pixelLeft += 10) + "px", oSym.addTask(1, arguments.callee, [b, c,
						k, j, e, g
					]), [this]
				)
		...
		PrivateBirth: function(a) {
			a.PrivateDie = oS.BrainsNum ? (a.DieStep = Math.floor(150 / oS.BrainsNum),
				function(d) {
					...
					(b = --oS.BrainsNum) ? (c = b * d.DieStep, $("imgFlagHead").style.left = (c - 11) +
						"px", $("imgFlagMeterFull").style.clip = "rect(0,157px,21px," + c + "px)") : ($(
							"imgFlagHead").style.left = "-1px", $("imgFlagMeterFull").style.clip =
						"rect(0,157px,21px,0)", oP.FlagToEnd())
				}) : function(b) {
				GameOver()
			}
		},
	...
	oStarfruit = InheritO(CPlants, {
		...
		PicArr: ["images/Card/Plants/Starfruit.png", "images/Plants/Starfruit/Starfruit.gif",
		...
		PrivateBirth: function(d) {
			var c = d.pixelLeft + 38,
				b = c - 15,
				a = d.pixelTop + 20;
			d.BulletEle = NewImg(0, "images/Plants/Starfruit/Star.gif", "left:" + b + "px;top:" + a +
				"px;z-index:" + (d.zIndex + 2))
		},
		PrivateDie: function(a) {
			a.BulletEle = null
		},
		...
		NormalAttack: function() {
			...
			(function(h) {
				...
				oSym.addTask(1, function(m, k, l, i, j) {
					j(oZ.getZ1(m, k), 4, i) && ((m -= 5) < 100 ? ClearChild(i) : (i.style.left = (
						l -= 5) + "px", oSym.addTask(1, arguments.callee, [m, k, l, i,
						j
					])))
			...
			(function(h) {
				...
				oSym.addTask(1, function(m, n, l, k, i, j) {
					j(oZ.getRangeLeftZ(m, n, l), 6, i) && ((k -= 5) < -15 ? ClearChild(i) : (i.style
						.top = k + "px", oSym.addTask(1, arguments.callee, [m, n, GetR(k +
							15), k, i, j])))
			...
			(function(h) {
				...
				oSym.addTask(1, function(m, n, l, k, i, j) {
					j(oZ.getRangeLeftZ(m, n, l), 2, i) && ((k += 5) > 600 ? ClearChild(i) : (i.style
						.top = k + "px", oSym.addTask(1, arguments.callee, [m, n, GetR(k +
							15), k, i, j])))
				}, [d, e, c, b, EditEle(g.BulletEle.cloneNode(false), {
					id: h
			...
			(function(h) {
				...
				oSym.addTask(1, function(n, l, m, k, i, j) {
					j(oZ.getZ0(n, l), 7, i) && ((n += 4) > 900 || (k -= 3) < -15 ? ClearChild(i) : (
						SetStyle(i, {
							left: (m += 4) + "px",
							top: k + "px"
			...
			(function(h) {
				...
				oSym.addTask(1, function(n, l, m, k, i, j) {
					j(oZ.getZ0(n, l), 1, i) && ((n += 4) > 900 || (k += 3) > 600 ? ClearChild(i) : (
						SetStyle(i, {
							left: (m += 4) + "px",
							top: k + "px"
						}), oSym.addTask(1, arguments.callee, [n, GetR(k + 15), m, k, i, j])
	...
	oPeashooter = InheritO(CPlants, {
		...
		PicArr: ["images/Card/Plants/Peashooter.png", "images/Plants/Peashooter/Peashooter.gif",
			"images/Plants/Peashooter/Peashooter.gif", "images/Plants/PB00.gif",
		...
		PrivateBirth: function(a) {
			a.BulletEle = NewImg(0, a.PicArr[3], "left:" + (a.AttackedLX - 40) + "px;top:" + (a.pixelTop + 3) +
		...
		NormalAttack: function() {
			...
			oSym.addTask(1, function(f, j, h, c, n, i, m, k, o, g) {
				var l, e = GetC(n),
					d = oZ["getZ" + c](n, i);
				m == 0 && g[i + "_" + e] && k != e && (PlayAudio("firepea"), m = 1, h = 40, k = e, j
					.src = "images/Plants/PB" + m + c + ".gif");
				d && d.Altitude == 1 ? (d[{
						"-1": "getSnowPea",
						0: "getPea",
						1: "getFirePea"
						...
						left: o + 28 + "px"
					})).src = ['images/Plants/PeaBulletHit.gif', 'images/Plants/PeaBulletHit2.gif'][
						m
					], oSym.addTask(10, ClearChild, [j])) : (n += (l = !c ? 5 : -5)) < oS.W && n > 100 ?
					(j.style.left = (o += l) + "px", oSym.addTask(1, arguments.callee, [f, j, h, c, n,
						i, m, k, o, g
					])) : ClearChild(j)
	...
	oLotusRoot = InheritO(oPeashooter, {
		...
		PicArr: ["images/Card/Plants/LotusRoot.png", "images/Plants/LotusRoot/Peashooter.gif",
			"images/Plants/LotusRoot/Peashooter.gif", "images/Plants/LotusRoot/Missile.png",
		...
		NormalAttack: function() {
			...
			oSym.addTask(1, function(f, j, h, c, n, i, m, k, o, g) {
				var l, e = GetC(n),
					d = oZ["getZ" + c](n, i);
				m == 0 && g[i + "_" + e] && k != e && (PlayAudio("firepea"), m = 1, h = 40, k = e, j
					.src = "images/Plants/LotusRoot/Missile.png");
				d && d.Altitude == 1 ? (d[{
						"-1": "getSnowPea",
						0: "getPea",
						1: "getFirePea"
						...
						left: o + 28 + "px"
					})).src = "images/Plants/LotusRoot/BulletHit.png", oSym.addTask(10, ClearChild,
						[j])) : (n += (l = !c ? 5 : -5)) < oS.W && n > 100 ? (j.style.left = (o += l) +
						"px", oSym.addTask(1, arguments.callee, [f, j, h, c, n, i, m, k, o, g])) :
					ClearChild(j)
	...
	oSnowPea = InheritO(oPeashooter, {
		...
		SunNum: 175,
		BKind: -1,
		PicArr: ["images/Card/Plants/SnowPea.png", "images/Plants/SnowPea/SnowPea.gif",
			"images/Plants/SnowPea/SnowPea.gif", "images/Plants/PB-10.gif", "images/Plants/PeaBulletHit1.gif"
		],
		...
		NormalAttack: function() {
			...
			oSym.addTask(1, function(f, j, h, c, n, i, m, k, o, g) {
				var l, e = GetC(n),
					d = oZ["getZ" + c](n, i);
				m < 1 && g[i + "_" + e] && k != e && (PlayAudio("firepea"), ++m && (h = 40), k = e, j
					.src = "images/Plants/PB" + m + c + ".gif");
				d && d.Altitude == 1 ? (d[{
					"-1": "getSnowPea",
					0: "getPea",
					...
					left: o + 28 + "px"
				})).src = "images/Plants/PeaBulletHit1.gif", oSym.addTask(10, ClearChild, [j])) : (
					n += (l = !c ? 5 : -5)) < oS.W && n > 100 ? (j.style.left = (o += l) + "px",
					oSym.addTask(1, arguments.callee, [f, j, h, c, n, i, m, k, o, g])) : ClearChild(
					j)
	...
	oSnowRepeater = InheritO(oSnowPea, {
		...
		CName: "寒冰双发射手",
		SunNum: 250,
		PicArr: ["images/Card/Plants/SnowRepeater.png", "images/Plants/SnowRepeater/SnowPea.gif",
			"images/Plants/SnowRepeater/SnowPea.gif", "images/Plants/PB-10.gif",
	...
	oRepeater = InheritO(oPeashooter, {
		...
		beAttackedPointR: 53,
		SunNum: 200,
		PicArr: ["images/Card/Plants/Repeater.png", "images/Plants/Repeater/Repeater.gif",
	...
	oFive = InheritO(oPeashooter, {
		...
		PrivateBirth: function(c) {
			...
			c.BulletEle = NewImg(0, c.PicArr[3], "left:" + a + "px;top:" + (c.pixelTop + 8) +
				"px;visibility:hidden;z-index:" + (c.zIndex + 2))
		},
		CanGrow: function(c, b, f) {
			var a = b + "_" + f,
				d = c[1],
				e = oS.ArP;
			return e ? oGd.$LF[b] == 1 ? f > 0 && f < e.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || d) :
				c[0] && !d : d && d.EName == "oRepeater" ? 1 : oGd.$LF[b] == 1 ? !(f < 1 || f > 9 || oGd
					.$Crater[a] || oGd.$Tombstones[a] || d) : c[0] && !d
		},
		NormalAttack1: oPeashooter.prototype.NormalAttack,
		NormalAttack: function(a) {
	...
	oThreepeater = InheritO(oPeashooter, {
		...
		beAttackedPointR: 53,
		SunNum: 325,
		PicArr: ["images/Card/Plants/Threepeater.png", "images/Plants/Threepeater/Threepeater.gif",
			"images/Plants/Threepeater/Threepeater.gif", "images/Plants/PB00.gif",
			"images/Plants/PeaBulletHit.gif", "images/Plants/PeaBulletHit2.gif"
		],
		AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
		Tooltip: "一次射出三行的豌豆",
		...
		NormalAttack: function() {
			...
			for (a in c.oTrigger) {
				...
				oSym.addTask(1, function(h, l, j, e, p, k, o, m, q, i) {
					var n, g = GetC(p),
						f = oZ["getZ" + e](p, k);
					o == 0 && i[k + "_" + g] && m != g && (PlayAudio("firepea"), o = 1, j = 40, m = g, l
						.src = "images/Plants/PB" + o + e + ".gif");
					f && f.Altitude == 1 ? (f[{
							"-1": "getSnowPea",
							0: "getPea",
							1: "getFirePea"
						...
						][o], oSym.addTask(10, ClearChild, [l])) : (p += (n = !e ? 5 : -5)) < oS.W &&
						p > 100 ? (l.style.left = (q += n) + "px", oSym.addTask(1, arguments.callee, [h,
							l, j, e, p, k, o, m, q, i
						])) : ClearChild(l)
	...
	oGatlingPea = InheritO(oPeashooter, {
		...
		beAttackedPointR: 68,
		SunNum: 275,
		PicArr: ["images/Card/Plants/GatlingPea.png", "images/Plants/GatlingPea/GatlingPea.gif",
			"images/Plants/GatlingPea/GatlingPea.gif", "images/Plants/PB00.gif",
			"images/Plants/PeaBulletHit.gif"
		],
		AudioArr: ["splat1", "splat2", "splat3", "plastichit", "shieldhit", "shieldhit2"],
		Tooltip: "一次发射四颗豌豆<br>",
	...
	oSplitPea = InheritO(oPeashooter, {
		...
		beAttackedPointR: 72,
		SunNum: 125,
		PicArr: ["images/Card/Plants/SplitPea.png", "images/Plants/SplitPea/SplitPea.gif",
		...
		PrivateBirth: function(c) {
			...
			c.BulletEle = [NewImg(0, b[3], "left:" + (c.AttackedLX - 40) + a), NewImg(0, b[4], "left:" + (c
				.AttackedRX - 16) + a)], c.aTri = [0, 0]
		},
		PrivateDie: function(a) {
			a.BulletEle.length = 0
		},
			...
			var d = this,
				...
				b = function() {
					...
					oSym.addTask(1, function(i, m, k, f, q, l, p, n, r, j) {
						var o, h = GetC(q),
							g = oZ["getZ" + f](q, l);
						p == 0 && j[l + "_" + h] && n != h && (PlayAudio("firepea"), p = 1, k = 40, n =
							h, m.src = "images/Plants/PB" + p + f + ".gif");
						g && g.Altitude == 1 ? (g[{
								"-1": "getSnowPea",
								0: "getPea",
								1: "getFirePea"
								...
								'images/Plants/PeaBulletHit2.gif'
							][m], oSym.addTask(10, ClearChild, [m])) : (q += (o = !f ? 5 : -5)) < oS
							.W && q > 100 ? (m.style.left = (r += o) + "px", oSym.addTask(1, arguments
								.callee, [i, m, k, f, q, l, p, n, r, j])) : ClearChild(m)
	...
	oSunFlower = InheritO(CPlants, {
		...
		beAttackedPointR: 53,
		SunNum: 50,
		PicArr: ["images/Card/Plants/SunFlower.png", "images/Plants/SunFlower/SunFlower1.gif",
			"images/Plants/SunFlower/SunFlower1.gif", "images/Plants/SunFlower/SunFlower.gif"
		],
		...
		PrivateBirth: function(a) {
			oS.ProduceSun ? oSym.addTask(500, function(d, c, b) {
				$P[d] && (a.ChangePosition($(d), 1), oSym.addTask(100, function(h, g, f, e) {
					$P[h] && (AppearSun(Math.floor(g + Math.random() * 41), f, 50, 0), oSym
						.addTask(100, function(i) {
				...
				switch (c) {
					case 0:
						var d = (e.HP -= b);
						!(d % 100) && (AppearSun(Math.floor(GetX(e.C) - 40 + Math.random() * 41), GetY(e.R),
							25, 0), oSym.addTask(50, function(h, g) {
	...
	oTwinSunflower = InheritO(oSunFlower, {
		...
		beAttackedPointR: 63,
		SunNum: 150,
		PicArr: ["images/Card/Plants/TwinSunflower.png", "images/Plants/TwinSunflower/TwinSunflower1.gif",
			"images/Plants/TwinSunflower/TwinSunflower1.gif", "images/Plants/TwinSunflower/TwinSunflower.gif"
		],
		...
		CanGrow: function(c, b, f) {
			var a = b + "_" + f,
				...
				e = oS.ArP;
			return e ? oGd.$LF[b] == 1 ? f > 0 && f < e.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || d) :
				c[0] && !d : d && d.EName == "oSunFlower" ? 1 : oGd.$LF[b] == 1 ? !(f < 1 || f > 9 || oGd
					.$Crater[a] || oGd.$Tombstones[a] || d) : c[0] && !d
		},
		BirthStyle: function(c, e, b, a) {
			var d = b.childNodes[1];
			...
			oSym.addTask(500, function(f, d, c, e) {
				if (oS.Dkind == 1) {
					$P[f] && (a.ChangePosition($(f), 1), oSym.addTask(100, function(k, h, g, j, i) {
						AppearSun(Math.floor(h + Math.random() * 21), j, 50, 0), AppearSun(
							Math.floor(g + Math.random() * 21), j, 50, 0), oSym.addTask(
							100,
							function(l) {
	...
	oTwinSunflower2 = InheritO(oSunFlower, {
		...
		PicArr: ["images/Card/Plants/TwinSunflower2.png", "images/Plants/TwinSunflower/0.gif",
			"images/Plants/TwinSunflower/TwinSunflower1.gif", "images/Plants/TwinSunflower/TwinSunflower.gif"
		],
		Tooltip: "双胞向日葵的阳光产量是普通向日葵的两倍<br>",
		Produce: '双胞向日葵的阳光产量是普通向日葵的两倍。<p>阳光产量：<font color="#FF0000">双倍<br>可以种在普通向日葵上</font></p>这是一个疯狂的夜晚，禁忌的科学技术，让双</font><br>胞向日葵来到了这个世界。电闪雷鸣狂风怒吼</font><br>，都在表示着这个世界对他的拒绝。但是一切</font><br>无济于事，双子向日葵他却仍然活着！',
		...
		PrivateBirth: function(a) {
			...
			oSym.addTask(500, function(f, d, c, e) {
				$P[f] && (a.ChangePosition($(f), 1), oSym.addTask(100, function(k, h, g, j, i) {
					AppearSun(Math.floor(h + Math.random() * 20), j, 50, 0), AppearSun(Math
						.floor(g + Math.random() * 20), j, 50, 0), oSym.addTask(100,
						function(l) {
							$P[l] && a.ChangePosition($(l), 0)
						}, [k]), oSym.addTask(2400, i, [k, h, g, j])
				}, [f, d, c, e, arguments.callee]))
		...
		PrivateBirth: function(a) {
			...
			oSym.addTask(0, function(f, d, c, e) {
				$P[f] && (a.ChangePosition($(f), 1), oSym.addTask(0, function(k, h, g, j, i) {
					AppearSun(Math.floor(h + Math.random() * 20), j, 50, 0), AppearSun(Math
						.floor(g + Math.random() * 20), j, 50, 0), AppearSun(Math.floor(
						h + Math.random() * 20), j, 50, 0), AppearSun(Math.floor(g +
						Math.random() * 20), j, 50, 0), AppearSun(Math.floor(h + Math
						.random() * 20), j, 50, 0), AppearSun(Math.floor(g + Math
						.random() * 20), j, 50, 0), oSym.addTask(100, function(l) {
						$P[l] && a.ChangePosition($(l), 0)
	...
	oPumpkinHead = InheritO(CPlants, {
		...
		coolTime: 30,
		zIndex: 1,
		PicArr: ["images/Card/Plants/PumpkinHead.png", "images/Plants/PumpkinHead/PumpkinHead.gif",
		...
		BirthStyle: function(c, d, b, a) {
			...
			NewImg(d + "_2", "images/Plants/PumpkinHead/PumpkinHead2.gif", "left:" + c.pixelLeft + "px;top:" + c
				.pixelTop + "px;z-index:" + (c.zIndex - 2), EDPZ)
		},
		PrivateDie: function(a) {
			ClearChild($(a.id + "_2"))
		}
	...
	oFlowerPot = InheritO(CPlants, {
		...
		CanGrow: function(e, d, f) {
			var c = d + "_" + f,
				b = oGd.$LF[d],
				a = f < 1 || f > 9;
			return b % 2 ? b < 3 ? !(a || e[1] || e[2] || e[0] || oGd.$Crater[c] || oGd.$Tombstones[c]) : !(a ||
				e[0] || oGd.$Crater[c]) : 0
		},
		Tooltip: "可以让植物栽种在屋顶上",
	...
	oFlowerPotAir1 = InheritO(CPlants, {
		...
		canEat: 0,
		PicArr: ["images/Card/Plants/FlowerPot.png", "images/Plants/AirPlant/one.png",
			"images/Plants/AirPlant/one.png"
		],
		PKind: 0,
		Stature: -1,
		GetDY: function(b, c, a) {
	...
	oFlowerPotAir2 = InheritO(CPlants, {
		...
		canEat: 0,
		PicArr: ["images/Card/Plants/FlowerPot.png", "images/Plants/AirPlant/one1.png",
			"images/Plants/AirPlant/one1.png"
		],
		PKind: 0,
		Stature: -1,
		GetDY: function(b, c, a) {
	...
	oFlowerPotAir3 = InheritO(CPlants, {
		...
		canEat: 0,
		PicArr: ["images/Card/Plants/FlowerPot.png", "images/Plants/AirPlant/one2.png",
			"images/Plants/AirPlant/one2.png"
		],
		PKind: 0,
		Stature: -1,
		GetDY: function(b, c, a) {
	...
	oCFlowerPot = InheritO(oFlowerPot, {
		EName: "oCFlowerPot",
		coolTime: 0,
		PicArr: ["images/Card/Plants/CFlowerPot.png", "images/Plants/FlowerPot/C/CFlowerPot.gif",
	...
	oPotatoMine = InheritO(CPlants, {
		...
		PicArr: ["images/Card/Plants/PotatoMine.png", "images/Plants/PotatoMine/PotatoMine.gif",
		...
		PrivateBirth: function(b, a) {
			!a && oSym.addTask(1500, function(d) {
				var c = $P[d];
				c && ($(d).childNodes[1].src = "images/Plants/PotatoMine/PotatoMine.gif", c.Status = 1,
					c.canTrigger = 1, c.getHurt = c.getHurt2)
			}, [b.id])
		},
		getTriggerRange: function(a, b, c) {
			return [
		...
		TriggerCheck: function(e, c) {
			var a = this.R,
				b = this.C;
			e.beAttacked && e.Altitude < 2 && !oGd.$[a + "_" + b + "_2"] && this.NormalAttack(this.pixelLeft,
				this.pixelRight, this.R)
		},
	...
	oTorchwood = InheritO(CPlants, {
		...
		beAttackedPointR: 53,
		SunNum: 175,
		PicArr: ["images/Card/Plants/Torchwood.png", "images/Plants/Torchwood/Torchwood.gif",
		...
		NormalAttack: function() {
			...
			oSym.addTask(1, function(f, j, h, c, n, i, m, k, o, g) {
				...
				d && d.Altitude == 1 ? (d[{
					...
					left: o + 28 + "px"
				})).src = "images/Plants/PeaBulletHit2.gif", oSym.addTask(75, ClearChild, [j])) : (
					n += (l = !c ? 5 : -5)) < oS.W && n > 100 ? (j.style.left = (o += l) + "px",
					oSym.addTask(1, arguments.callee, [f, j, h, c, n, i, m, k, o, g])) : ClearChild(
					j)
			}, [b, $(b), 20, 0, a.AttackedLX, a.R, 0, 0, a.AttackedLX - 40, oGd.$Torch]);
	...
	oWallNut = InheritO(CPlants, {
		...
		coolTime: 15.5,
		HP: 4000,
		PicArr: ["images/Card/Plants/WallNut.png", "images/Plants/WallNut/WallNut.gif",
		...
		CanGrow: function(c, b, f) {
			var a = b + "_" + f,
				...
				e = oS.ArP;
			return e ? oGd.$LF[b] == 1 ? f > 0 && f < e.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || d) :
				c[0] && !d : d && d.EName == "oWallNut" ? 1 : oGd.$LF[b] == 1 ? !(f < 1 || f > 9 || oGd.$Crater[
					a] || oGd.$Tombstones[a] || d) : c[0] && !d
		},
		InitTrigger: function() {},
		HurtStatus: 0,
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 1334 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src =
				"images/Plants/WallNut/Wallnut_cracked2.gif") : c.HP < 2667 && c.HurtStatus < 1 && (c
				.HurtStatus = 1, d.src = "images/Plants/WallNut/Wallnut_cracked1.gif"): c.Die(1)
		}
	}),
	oLing = InheritO(oWallNut, {
		...
		getHurt: function(e, b, a) {
			var c = this,
				d = $(c.id).childNodes[1];
			!(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 1334 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src =
				"images/Plants/Ling/Ling.gif") : c.HP < 2667 && c.HurtStatus < 1 && (c.HurtStatus = 1, d
				.src = "images/Plants/Ling/Ling.gif"): c.Die(1)
		}
	}),
		...
		PrivateBirth: function(c) {
			...
			(function(z, y, q, r, p, x, e, g, b) {
				...
				if (z.CanAttack && (A = oZ.getZ0(r, a)) && A.getCrushed(z)) {
					...
					oSym.addTask(1, arguments.callee, [z, y, z.AttackedLX + 20, z.AttackedRX + 20, z
						.pixelLeft + 20, x, e, g, b
					])
				} else {
					switch (e) {
						case 1:
					...
					q > y ? z.Die() : (i = GetC(z.pixelRight += 2), z.AttackedLX = q += 2, z.AttackedRX =
						r += 2, w = GetR(z.pixelBottom += e * 2), SetStyle(x, {
							left: (z.pixelLeft = p += 2) + "px",
							top: (z.pixelTop += e * 2) + "px"
						}), w != a && (z.R = w, t = true, !z.CanAttack && (z.CanAttack = 1)), i != l &&
						(z.C = i, t = true), t && (oGd.del({
							R: a,
							C: l,
							PKind: 1
						}), oGd.add(z, w + "_" + i + "_1")), oSym.addTask(1, arguments.callee, [z, y, z
							.AttackedLX, z.AttackedRX, z.pixelLeft, x, e, g, b
						]))
				}
	...
	oHugeNutBowling = InheritO(oNutBowling, {
		...
		HP: 8000,
		Stature: 1,
		PicArr: ["images/Card/Plants/HugeWallNut.png", "images/Plants/WallNut/2.gif",
		...
		PrivateBirth: function(a) {
			...
			(function(b, c, n, m, e, g) {
				...
				n > c ? b.Die() : (j = GetC(b.pixelRight += 2), b.AttackedLX = n += 2, b.AttackedRX = m +=
					2, g.style.left = (b.pixelLeft += 2) + "px", j != h && (b.C = j, oGd.del({
						R: l,
						C: h,
						PKind: 1
					}), oGd.add(b, l + "_" + j + "_1")), oSym.addTask(1, arguments.callee, [b, c, n, m,
						e, g
					]))
			})(a, oS.W, a.AttackedLX, a.AttackedRX, a.R, $(a.id))
		}
	...
	oBoomNutBowling = InheritO(oNutBowling, {
		...
		CName: "爆炸坚果",
		PicArr: ["images/Card/Plants/BoomWallNut.png", "images/Plants/WallNut/1.gif",
			"images/Plants/WallNut/BoomWallNutRoll.gif", "images/Plants/CherryBomb/Boom.gif"
		],
		...
		PrivateBirth: function(a) {
			...
			(function(s, q, b, c, m) {
				...
				if ((t = oZ.getZ0(c, v)) && t.getCrushed(s)) {
					...
					b > q ? s.Die() : (l = GetC(s.pixelRight += 2), s.AttackedLX = b += 2, s.AttackedRX =
						c += 2, SetStyle(m, {
							...
							C: p,
							PKind: 1
						}), oGd.add(s, v + "_" + l + "_1")), oSym.addTask(1, arguments.callee, [s, q, s
							.AttackedLX, s.AttackedRX, m
						]))
				}
	...
	oTallNut = InheritO(oWallNut, {
		...
		HP: 8000,
		coolTime: 24.5,
		PicArr: ["images/Card/Plants/TallNut.png", "images/Plants/TallNut/TallNut.gif",
		...
		CanGrow: function(c, b, f) {
			var a = b + "_" + f,
				...
				e = oS.ArP;
			return e ? oGd.$LF[b] == 1 ? f > 0 && f < e.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || d) :
				c[0] && !d : d && d.EName == "oTallNut" ? 1 : oGd.$LF[b] == 1 ? !(f < 1 || f > 9 || oGd.$Crater[
					a] || oGd.$Tombstones[a] || d) : c[0] && !d
		},
		Stature: 1,
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 2667 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src =
				"images/Plants/TallNut/TallnutCracked2.gif") : c.HP < 5333 && c.HurtStatus < 1 && (c
	...
	oTenManNute = InheritO(CPlants, {
		...
		Stature: 1,
		canEat: 1,
		PicArr: ["images/Card/Plants/TenManNute.png", "images/Plants/TenManNut/Spikeweed.gif",
		...
		TriggerCheck: function(i, h) {
			...
			i.PZ && !g[c] && (a = i.AttackedLX, b = i.AttackedRX, e = this.AttackedLX, f = this.AttackedRX, a <=
				f && a >= e || b <= f && b >= e || a <= e && b >= f) && this.AttackCheck2(i) && (g[c] = 1,
	...
	oTenManNut = InheritO(CPlants, {
		...
		Stature: 1,
		canEat: 1,
		PicArr: ["images/Card/Plants/TenManNut.png", "images/Plants/TenManNut/Spikeweed.gif",
			"images/Plants/TenManNut/Spikeweed.gif"
		],
		Attack: 40,
		ArZ: {},
	...
	//【排山倒海】藤曼坚果
	oTenManNutp = InheritO(oTenManNut, {
		EName: "oTenManNutp",
		PrivateBirth: function(a) {
			var R = a.R,
				C = a.C,
			...
			for (R1 = R - 4; R1 <= R + 4; R1++) {
				if (R1 > 0 && R1 <= MaxR) {
					...
					for (C1 = C; C1 <= C; C1++) {
						...
						if (C1 > 0 && C1 <= MaxC && (LFR == 1 || LFR == 3)) {
							rc = R1 + '_' + C1 + '_';
							!(_$[rc + 0] || _$[rc + 1] || _$[rc + 2]) && CustomSpecial(oTenManNut, R1, C1);
						}
					}
				}
			}
	...
	oCherryBomb = InheritO(CPlants, {
		...
		PicArr: ["images/Card/Plants/CherryBomb.png", "images/Plants/CherryBomb/0.gif",
			"images/Plants/CherryBomb/CherryBomb.gif", "images/Plants/CherryBomb/Boom.gif" + $Random
		],
		AudioArr: ["cherrybomb"],
	...
	//【排山倒海】樱桃炸弹
	oCherryBombp = InheritO(oCherryBomb, {
		EName: "oCherryBombp",
		PrivateBirth: function(a) {
			var R = a.R,
				C = a.C,
			...
			for (R1 = R - 4; R1 <= R + 4; R1++) {
				if (R1 > 0 && R1 <= MaxR) {
					...
					for (C1 = C; C1 <= C; C1++) {
						...
						if (C1 > 0 && C1 <= MaxC && (LFR == 1 || LFR == 3)) {
							rc = R1 + '_' + C1 + '_';
							!(_$[rc + 0] || _$[rc + 1] || _$[rc + 2]) && CustomSpecial(oCherryBomb, R1, C1);
						}
					}
				}
			}
...
oCherryBombs = InheritO(oCherryBomb, {
	...
	oSpikeweeden = InheritO(CPlants, {
		...
		PicArr: ["images/Card/Plants/Spikeweed.png", "images/Plants/AirPlant/none.png",
			"images/Plants/AirPlant/none.png"
		],
		Attack: 20,
		ArZ: {},
		...
		CanGrow: function(c, b, e) {
			var a = b + "_" + e,
				d = oS.ArP;
			return d ? e > 0 && e < d.ArC[1] && oGd.$LF[b] == 1 && !(c[1] || c[0]) : !(e < 1 || e > 9 || oGd
				.$LF[b] - 1 || c[1] || c[0] || oGd.$Crater[a] || oGd.$Tombstones[a])
		},
		getHurt: function(d, b, a) {
			var c = this;
			switch (b) {
	...
	oSpikerock = InheritO(oSpikeweed, {
		...
		PicArr: ["images/Card/Plants/Spikerock.png", "images/Plants/Spikerock/Spikerock.gif",
			"images/Plants/Spikerock/Spikerock.gif", "images/Plants/Spikerock/2.gif",
	...
	oGarlic = InheritO(CPlants, {
		...
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/Garlic/Garlic.gif",
			"images/Plants/Garlic/Garlic.gif", "images/Plants/Garlic/Garlic_body2.gif",
		...
		CanGrow: function(c, b, f) {
			var a = b + "_" + f,
				...
				e = oS.ArP;
			return e ? oGd.$LF[b] == 1 ? f > 0 && f < e.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || d) :
				c[0] && !d : d && d.EName == "oGarlic" ? 1 : oGd.$LF[b] == 1 ? !(f < 1 || f > 9 || oGd.$Crater[
					a] || oGd.$Tombstones[a] || d) : c[0] && !d
		},
		InitTrigger: function() {},
		HurtStatus: 0,
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 20) < 1 ? c.Die() : (e.ChangeR({
				R: c.R
			}), c.HP < 134 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src =
				"images/Plants/Garlic/Garlic_body3.gif") : c.HP < 267 && c.HurtStatus < 1 && (c
				.HurtStatus = 1, d.src = "images/Plants/Garlic/Garlic_body2.gif")): c.Die(1)
		}
	}),
	oGarlicss = InheritO(CPlants, {
		...
		HP: 4000000000,
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/Garlicss/g.png", "images/Plants/Garlicss/g.png",
			"images/Plants/Garlicss/g.png", "images/Plants/Garlicss/g.png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		CanGrow: function(c, b, f) {
			var a = b + "_" + f,
				...
				e = oS.ArP;
			return e ? oGd.$LF[b] == 1 ? f > 0 && f < e.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || d) :
				c[0] && !d : d && d.EName == "oGarlicss" ? 1 : oGd.$LF[b] == 1 ? !(f < 1 || f > 9 || oGd
					.$Crater[a] || oGd.$Tombstones[a] || d) : c[0] && !d
		},
		InitTrigger: function() {},
		HurtStatus: 0,
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 0) < 1 ? c.Die() : (e.ChangeR({
				...
				"images/Plants/Garlicss/g.png") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus = 1, d
				.src = "images/Plants/Garlicss/g.png")): c.Die(1)
		}
	}),
	oshitou = InheritO(CPlants, {
		...
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/shitou/shitou" + parseInt(Math.random() * 4) +
			".png", "images/Plants/shitou/shitou" + parseInt(Math.random() * 4) + ".png",
			"images/Plants/shitou/shitou" + parseInt(Math.random() * 4) + ".png",
			"images/Plants/shitou/shitou" + parseInt(Math.random() * 4) + ".png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		...
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 0) < 1 ? c.Die() : (e.ChangeR({
					...
					"images/Plants/shitou/shitou" + parseInt(Math.random() * 4) + ".png") : c.HP < 267 && c
				.HurtStatus < 1 && (c.HurtStatus = 1, d.src = "images/Plants/shitou/shitou" + parseInt(Math
					.random() * 4) + ".png")): c.Die(1)
		}
	}),
	oshitou0 = InheritO(CPlants, {
		...
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/shitou/shitou0.png",
			"images/Plants/shitou/shitou0.png", "images/Plants/shitou/shitou0.png",
			"images/Plants/shitou/shitou0.png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		CanGrow: function(c, b, f) {
		...
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 0) < 1 ? c.Die() : (e.ChangeR({
				...
				"images/Plants/shitou/shitou0.png") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus =
				1, d.src = "images/Plants/shitou/shitou0.png")): c.Die(1)
		}
	}),
	oshitou1 = InheritO(CPlants, {
		...
		HP: 400000000000,
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/shitou/shitou1.png",
			"images/Plants/shitou/shitou1.png", "images/Plants/shitou/shitou1.png",
			"images/Plants/shitou/shitou1.png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		CanGrow: function(c, b, f) {
		...
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 0) < 1 ? c.Die() : (e.ChangeR({
				...
				"images/Plants/shitou/shitou1.png") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus =
				1, d.src = "images/Plants/shitou/shitou1.png")): c.Die(1)
		}
	}),
	oshitou2 = InheritO(CPlants, {
		...
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/shitou/shitou2.png",
			"images/Plants/shitou/shitou2.png", "images/Plants/shitou/shitou2.png",
			"images/Plants/shitou/shitou2.png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		CanGrow: function(c, b, f) {
		...
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 0) < 1 ? c.Die() : (e.ChangeR({
				...
				"images/Plants/shitou/shitou2.png") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus =
				1, d.src = "images/Plants/shitou/shitou2.png")): c.Die(1)
		}
	}),
	oshitou3 = InheritO(CPlants, {
		...
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/shitou/shitou3.png",
			"images/Plants/shitou/shitou3.png", "images/Plants/shitou/shitou3.png",
			"images/Plants/shitou/shitou3.png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		CanGrow: function(c, b, f) {
		...
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 0) < 1 ? c.Die() : (e.ChangeR({
				...
				"images/Plants/shitou/shitou3.png") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus =
				1, d.src = "images/Plants/shitou/shitou3.png")): c.Die(1)
		}
	}),
	oAirZ = InheritO(CPlants, {
		...
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/AirPlant/none.png",
			"images/Plants/AirPlant/none.png", "images/Plants/AirPlant/none.png",
			"images/Plants/AirPlant/none.png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		...
		getHurt: function(e, b, a) {
			...
			!(b % 3) ? (c.HP -= 0) < 1 ? c.Die() : (e.ChangeR({
				...
				"images/Plants/AirPlant/none.png") : c.HP < 267 && c.HurtStatus < 1 && (c.HurtStatus =
				1, d.src = "images/Plants/AirPlant/none.png")): c.Die(1)
		}
	}),
	oTitle = InheritO(CPlants, {
		...
		coolTime: 0,
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/Title/TFR.png", "images/Plants/Title/TFR.png",
			"images/Plants/Title/TFR.png", "images/Plants/Title/TFR.png"
		],
		Tooltip: "将僵尸赶到其它的横行",
		Produce: '大蒜可以让僵尸改变前进的路线。<p>范围：<font color="#FF0000">近距离接触</font><br>特点：<font color="#FF0000">改变僵尸的前进路线</font></p>路线转向，这不仅仅是大蒜的专业，更是他</font><br>的热情所在。他在布鲁塞尔大学里，获得了转向</font><br>学的博士学位。他能把路线向量和反击阵列，讲</font><br>上一整天。他甚至会把家里的东西，推到街上去</font><br>。不知道为啥，他老婆还可以忍受这些。',
		CanGrow: function(c, b, f) {
	...
	oTitle1 = InheritO(oTitle, {
		EName: "oTitle1",
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/Title/F777.png", "images/Plants/Title/F777.png",
			"images/Plants/Title/F777.png", "images/Plants/Title/F777.png"
		]
	}),
	oTitle2 = InheritO(oTitle, {
		EName: "oTitle2",
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/Title/Valcos.png",
			"images/Plants/Title/Valcos.png", "images/Plants/Title/Valcos.png", "images/Plants/Title/Valcos.png"
		]
	}),
	oTitle3 = InheritO(oTitle, {
		EName: "oTitle3",
		PicArr: ["images/Card/Plants/Garlic.png", "images/Plants/Title/Tobu.png", "images/Plants/Title/Tobu.png",
			"images/Plants/Title/Tobu.png", "images/Plants/Title/Tobu.png"
		]
	}),
	oSquash = InheritO(CPlants, {
		...
		beAttackedPointR: 67,
		SunNum: 50,
		PicArr: ["images/Card/Plants/Squash.png", "images/Plants/Squash/Squash.gif",
			"images/Plants/Squash/Squash.gif", "images/Plants/Squash/SquashAttack.gif",
			"images/Plants/Squash/SquashL.png", "images/Plants/Squash/SquashR.png"
		],
		...
		getHurt: function(d, b, a) {
			var c = this;
			b != 3 ? c.NormalAttack(c, d.id, d.ZX + d.Speed * 4 * (!d.WalkDirection ? -1 : 1) - 50) : (c.HP -=
				a) < 1 && c.Die()
		},
		getTriggerRange: function(a, b, c) {
			return [
		...
		TriggerCheck: function(h, g, e) {
			var c = h.ZX,
				...
				a = $(b).childNodes[1],
				f = h.isAttacking;
			h.beAttacked && h.Altitude > -1 && h.Altitude < 2 && (f || !f && c - this.AttackedRX < 71) && (
				PlayAudio("squash_hmm"), oT.$[this.R].splice(e, 1), a.src = c > this.AttackedRX ?
				"images/Plants/Squash/SquashR.png" : "images/Plants/Squash/SquashL.png", oSym.addTask(100,
					function(d, j, i) {
						var k = $P[d];
	...
	oChomper = InheritO(CPlants, {
		...
		SunNum: 150,
		AudioArr: ["bigchomp"],
		PicArr: ["images/Card/Plants/Chomper.png", "images/Plants/Chomper/Chomper.gif",
		...
		NormalAttack: function(a, b) {
			...
			oSym.addTask(70, function(c, d) {
				...
				$P[c] && oSym.addTask(18, function(e, f) {
					var g = $P[e],
						h;
					g && ((h = $Z[f]) && h.beAttacked && h.PZ ? $(e).childNodes[1].src = h
						.getRaven(e) ? (oSym.addTask(4200, function(i) {
							var j = $P[i];
							j && (j.canTrigger = 1, $(i).childNodes[1].src =
								"images/Plants/Chomper/Chomper.gif")
						}, [e]), "images/Plants/Chomper/ChomperDigest.gif") : (g
							.canTrigger = 1, "images/Plants/Chomper/Chomper.gif") : oSym
						.addTask(18, function(i) {
							var j = $P[i];
							j && (j.canTrigger = 1, $(i).childNodes[1].src =
								"images/Plants/Chomper/Chomper.gif")
						}, [e]))
	...
	oBigChomper = InheritO(oChomper, {
		...
		CName: "超级大嘴花",
		coolTime: 15,
		PicArr: ["images/Card/Plants/BigChomper.png", "images/Plants/BigChomper/Chomper.gif",
			"images/Plants/BigChomper/Chomper.gif", "images/Plants/BigChomper/ChomperAttack.gif",
			...
			oSym.addTask(70, function(c, d) {
				...
				$P[c] && oSym.addTask(9, function(e, f) {
					var g = $P[e],
						h;
					g && ((h = $Z[f]) && h.beAttacked && h.PZ ? $(e).childNodes[1].src = h
						.getRaven(e) ? (oSym.addTask(2100, function(i) {
							var j = $P[i];
							j && (j.canTrigger = 1, $(i).childNodes[1].src =
								"images/Plants/BigChomper/Chomper.gif")
						}, [e]), "images/Plants/BigChomper/ChomperDigest.gif") : (g
							.canTrigger = 1, "images/Plants/BigChomper/Chomper.gif") : oSym
						.addTask(9, function(i) {
							var j = $P[i];
							j && (j.canTrigger = 1, $(i).childNodes[1].src =
								"images/Plants/BigChomper/Chomper.gif")
						}, [e]))
	...
	oFumeShroom = InheritO(CPlants, {
		...
		SleepGif: 3,
		night: true,
		PicArr: ["images/Card/Plants/FumeShroom.png", "images/Plants/FumeShroom/FumeShroom.gif",
		...
		PrivateBirth: function(b) {
			var a = b.id;
			NewEle(a + "_Bullet", "div", "position:absolute;visibility:hidden;width:343px;height:62px;left:" + b
				.AttackedRX + "px;top:" + (b.pixelTop + 5) +
				"px;background:url(images/Plants/FumeShroom/FumeShroomBullet.gif);z-index:" + (b.zIndex +
					1), 0, EDPZ)
		},
		PrivateDie: function(a) {
		...
		NormalAttack: function() {
			...
			ImgSpriter(a, c, [
				...
				var h = $(j);
				$P[j] && (h.childNodes[1].src = "images/Plants/FumeShroom/FumeShroom.gif", SetHidden($(
					i)))
			})
		}
	}),
	...
	oCoffeeBean = InheritO(CPlants, {
		...
		PKind: 3,
		canEat: 0,
		PicArr: ["images/Card/Plants/CoffeeBean.png", "images/Plants/CoffeeBean/CoffeeBean.gif",
			"images/Plants/CoffeeBean/CoffeeBean.gif", "images/Plants/CoffeeBean/CoffeeBeanEat.gif" + $Random
		],
		...
		PrivateBirth: function(a) {
			...
			oSym.addTask(240, function(c) {
				...
				var d = oGd.$[c],
					b;
				d && (b = d.WakeUP, (!b ? ($(d.id).childNodes[1].src = d.PicArr[d.NormalGif], d
					.canTrigger = 1, d.Sleep = 0) : b(d)));
				a.Die()
			}, [a.R + "_" + a.C + "_1"])
		}
	}),
	oGloomShroom = InheritO(oFumeShroom, {
		...
		beAttackedPointR: 92,
		SunNum: 150,
		PicArr: ["images/Card/Plants/GloomShroom.png", "images/Plants/GloomShroom/GloomShroom.gif",
		...
		CanGrow: function(c, b, f) {
			var a = b + "_" + f,
				...
				e = oS.ArP;
			return e ? oGd.$LF[b] == 1 ? f > 0 && f < e.ArC[1] && !(oGd.$Crater[a] || oGd.$Tombstones[a] || d) :
				c[0] && !d : d && d.EName == "oFumeShroom" ? 1 : oGd.$LF[b] == 1 ? !(f < 1 || f > 9 || oGd
					.$Crater[a] || oGd.$Tombstones[a] || d) : c[0] && !d
		},
		BirthStyle: function(c, d, b, a) {
			oS.DKind && (c.canTrigger = 0, c.Sleep = 1, b.childNodes[1].src = c.PicArr[c.SleepGif]);
		...
		PrivateBirth: function(b) {
			var a = b.id;
			NewEle(a + "_Bullet", "div", "position:absolute;visibility:hidden;width:210px;height:200px;left:" +
				(b.pixelLeft - 60) + "px;top:" + (b.pixelTop - 65) +
				"px;background:url(images/Plants/GloomShroom/GloomShroomBullet.gif);z-index:" + (b.zIndex +
					1), 0, EDPZ)
		},
		PrivateDie: function(a) {
			ClearChild($(a.id + "_Bullet"))
	...
	oPuffShroom = InheritO(oFumeShroom, {
		...
		SunNum: 0,
		Stature: -1,
		PicArr: ["images/Card/Plants/PuffShroom.png", "images/Plants/PuffShroom/PuffShroom.gif",
		...
		PrivateBirth: function(a) {
			a.BulletEle = NewImg(0, "images/Plants/ShroomBullet.gif", "left:" + (a.AttackedLX - 46) +
				"px;top:" + (a.pixelTop + 40) + "px;visibility:hidden;z-index:" + (a.zIndex + 2))
		},
		PrivateDie: function(a) {
			a.BulletEle = null
		},
		NormalAttack: function() {
			...
			oSym.addTask(1, function(j, d, e, f, g) {
				...
				h && h.Altitude == 1 ? (h.getPea(h, 20, 0), (SetStyle(d, {
					...
					d
				])) : (e += 5) < oS.W ? (d.style.left = (g += 5) + "px", oSym.addTask(1,
					arguments.callee, [j, d, e, f, g])) : ClearChild(d)
			}, [c, $(c), a, b.R, a - 46])
		}
	}),
	oScaredyShroom = InheritO(oFumeShroom, {
		...
		ArZ: [],
		Attacking: 0,
		PicArr: ["images/Card/Plants/ScaredyShroom.png", "images/Plants/ScaredyShroom/ScaredyShroom.gif",
		...
		TriggerCheck: function(e, c) {
			var b = this,
				a = b.id;
			e.PZ && Math.abs(e.ZX - b.MX) < 121 && e.beAttacked ? (b.ArZ.push(e.id), !b.Cry && (b.Cry = 1, $(a)
				.childNodes[1].src = "images/Plants/ScaredyShroom/ScaredyShroomCry.gif", b.CryCheck(a))) : (
		...
		PrivateBirth: function(c) {
			...
			c.BulletEle = NewImg(0, "images/Plants/ShroomBullet.gif", "left:" + a + "px;top:" + (c.pixelTop +
				35) + "px;visibility:hidden;z-index:" + (c.zIndex + 2));
			c.MX = b + 9
		},
		PrivateDie: function(a) {
			a.BulletEle = null
		...
		NormalAttack: function() {
			...
			oSym.addTask(1, function(k, e, f, g, h) {
				...
				i && i.Altitude == 1 ? (i.getPea(i, 20, 0), (SetStyle(e, {
					...
					e
				])) : (f += 5) < oS.W ? (e.style.left = (h += 5) + "px", oSym.addTask(1,
					arguments.callee, [k, e, f, g, h])) : ClearChild(e)
			}, [d, $(d), b, c.R, b - 46]);
			c.Attacking = 1;
	...
	oHypnoShroom = InheritO(oFumeShroom, {
		...
		coolTime: 30,
		HP: 1,
		PicArr: ["images/Card/Plants/HypnoShroom.png", "images/Plants/HypnoShroom/HypnoShroom.gif",
			"images/Plants/HypnoShroom/HypnoShroom.gif", "images/Plants/HypnoShroom/HypnoShroomSleep.gif"
		],
		Tooltip: "让一只僵尸为你作战",
	...
	oIceShroom = InheritO(oFumeShroom, {
		...
		SunNum: 75,
		coolTime: 50,
		PicArr: ["images/Card/Plants/IceShroom.png", "images/Plants/IceShroom/IceShroom.gif",
			"images/Plants/IceShroom/IceShroom.gif", "images/Plants/IceShroom/IceShroomSleep.gif",
			"images/Plants/IceShroom/Snow.gif", "images/Plants/IceShroom/icetrap.gif"
		],
		...
		PrivateDie: function(a) {},
		PrivateBirth: function(a) {
			!oS.DKind ? (a.NormalAttack(a.id), a.getHurt = function(d, c, b) {}) : a.getHurt = CPlants.prototype
				.getHurt
		},
		WakeUP: function(a) {
			var b = a.id;
			...
			oSym.addTask(100, function(c) {
				...
				if (f) {
					...
					oSym.addTask(40, function(g) {
						...
						(f.pixelLeft - 197) + "px " + (f.pixelTop - 80) + "px", 0, EDPZ)]);
					f.Die()
				}
			}, [a])
		}
	...
	oSunShrooms = InheritO(oFumeShroom, {
		...
		BirthStyle: function(c, d, b, a) {
			oS.DKind ? (c.canTrigger = 0, c.Sleep = 1, b.childNodes[1].src = "images/interface/Sun.gif") : (oSym
				.addTask(600, function(h, g, f) {
					var e = $P[h];
					e && e.ProduceSun(e, g, f)
				}, [d, GetX(c.C) - 40, GetY(c.R)]), oSym.addTask(0, function(f) {
					var e = $P[f];
					e && (e.Sleep = 0, $(f).childNodes[1].src = "images/interface/Sun.gif", e.Status =
						1)
				}, [d]));
			EditEle(b, {
				id: d
		...
		ProduceSun: function(a, c, b) {
			AppearSun(Math.floor(c + Math.random() * 41), b, !a.Status ? 15 : 25, 0), oSym.addTask(10, function(
				g, f, e) {
				var d = $P[g];
	...
	oSunShroom = InheritO(oFumeShroom, {
		...
		Stature: -1,
		Status: 0,
		PicArr: ["images/Card/Plants/SunShroom.png", "images/Plants/SunShroom/SunShroom.gif",
		...
		BirthStyle: function(c, d, b, a) {
			oS.DKind ? (c.canTrigger = 0, c.Sleep = 1, b.childNodes[1].src =
				...
				var e = $P[f];
				e && (e.Sleep = 0, $(f).childNodes[1].src = "images/Plants/SunShroom/SunShroom.gif",
					e.Status = 1)
			}, [d]));
			EditEle(b, {
				id: d
		...
		ProduceSun: function(a, c, b) {
			AppearSun(Math.floor(c + Math.random() * 41), b, !a.Status ? 15 : 25, 0), oSym.addTask(2400,
				function(g, f, e) {
					var d = $P[g];
					d && d.ProduceSun(d, f, e)
				}, [a.id, c, b])
	...
	oDoomShroom = InheritO(oFumeShroom, {
		...
		PicArr: ["images/Card/Plants/DoomShroom.png", "images/Plants/DoomShroom/0.gif",
			"images/Plants/DoomShroom/DoomShroom.gif", "images/Plants/DoomShroom/Sleep.gif",
			"images/Plants/DoomShroom/BeginBoom.gif", "images/Plants/DoomShroom/crater10.png",
			"images/Plants/DoomShroom/crater11.png", "images/Plants/DoomShroom/crater20.png",
			"images/Plants/DoomShroom/crater21.png", "images/Plants/DoomShroom/crater30.png",
			"images/Plants/DoomShroom/crater31.png", "images/Plants/DoomShroom/Boom.png"
		],
		...
		InitTrigger: function() {},
		BirthStyle: function(c, d, b, a) {
			oS.DKind ? (c.Sleep = 1, b.childNodes[1].src = c.PicArr[c.SleepGif]) : (c.Sleep = 0, c.getHurt =
				function() {}, b.childNodes[1].src = "images/Plants/DoomShroom/BeginBoom.gif", c
				.NormalAttack(d));
			EditEle(b, {
				id: d
			}, a, EDPZ)
		...
		NormalAttack: function(a) {
			oSym.addTask(50, function(c) {
				...
				if (d) {
					...
					(o = j[r + "_" + 2]) && o.Die();
					oGd.$Crater[r] = 2;
					NewEle(q, "div", "position:absolute;overflow:hidden;z-index:" + (d.zIndex + 2) +
						";width:283px;height:324px;left:" + (d.pixelLeft - 80) + "px;top:" + (d
							.pixelTop - 220) +
						"px;background:url(images/Plants/DoomShroom/Boom.png) no-repeat", 0, EDPZ);
		...
		setCrater: function(f, b, d, e, c) {
			...
			switch (oGd.$LF[b]) {
				case 1:
					a = NewEle(f, "div", "position:absolute;z-index:" + (3 * b - 1) +
						";overflow:hidden;background:url(images/Plants/DoomShroom/crater1" + oS.DKind +
						".png) no-repeat;width:90px;height:61px;left:" + (e || (GetX(d) - 45)) + "px;top:" +
						(c || (GetY(b) - 30)) + "px", 0, EDPZ);
					break;
				case 2:
					a = NewEle(f, "div", "position:absolute;z-index:" + (3 * b - 1) +
						";overflow:hidden;background:url(images/Plants/DoomShroom/crater2" + oS.DKind +
						".png) no-repeat;width:85px;height:53px;left:" + (e || (GetX(d) - 42)) + "px;top:" +
						(c || (GetY(b) - 26)) + "px", 0, EDPZ);
					break;
				case 3:
					a = NewEle(f, "div", "position:absolute;z-index:" + (3 * b - 1) +
						";overflow:hidden;background:url(images/Plants/DoomShroom/crater31.png) no-repeat;width:75px;height:77px;left:" +
						(e || (GetX(d) - 37)) + "px;top:" + (c || (GetY(b) - 19)) + "px", 0, EDPZ);
					break;
				default:
			}
	...
	oTangleKlep = InheritO(CPlants, {
		...
		NormalGif: 1,
		AudioArr: ["TangleKlep"],
		PicArr: ["images/Card/Plants/TangleKlep.png", "images/Plants/TangleKlep/Float.gif",
			"images/Plants/TangleKlep/Float.gif", "images/Plants/TangleKlep/Grab.png",
		...
		NormalAttack: function(a, b) {
			...
			b.beAttacked = 0;
			b.isAttacking = 1;
			NewImg(0, "images/Plants/TangleKlep/Grab.png", "left:" + b.beAttackedPointL + "px;top:" + (b
				.height - 67) + "px", b.Ele);
			oSym.addTask(50, function(g, h) {
				...
				var e = g.id,
					...
					d = e + "_splash",
					c = f + "_splash";
				NewEle(d, "div", "position:absolute;background:url(images/interface/splash.png);left:" +
					(g.pixelLeft - 4) + "px;top:" + (g.pixelTop - 16) +
					"px;width:97px;height:88px;over-flow:hidden", 0, EDPZ);
				NewEle(c, "div", "position:absolute;background:url(images/interface/splash.png);left:" +
					(h.AttackedLX - 10) + "px;top:" + (h.pixelTop + h.height - 88) +
					"px;width:97px;height:88px;over-flow:hidden", 0, EDPZ);
				ImgSpriter(d, e, [
					["0 0", 9, 1],
					["-97px 0", 9, 2],
	...
	oSeaShroom = InheritO(oPuffShroom, {
		...
		PicArr: ["images/Card/Plants/SeaShroom.png", "images/Plants/SeaShroom/SeaShroom.gif",
			"images/Plants/SeaShroom/SeaShroom.gif", "images/Plants/SeaShroom/SeaShroomSleep.gif",
			"images/Plants/ShroomBullet.gif", "images/Plants/ShroomBulletHit.gif"
		],
		CanGrow: function(c, b, d) {
			var a = b + "_" + d;
...
oCactus = InheritO(CPlants, {
	...
	Status: 0,
	PicArr: (function() {
		return ["images/Card/Plants/Cactus.png", "images/Plants/Cactus/Cactus.gif",
			"images/Plants/Cactus/Cactus.gif", "images/Plants/Cactus/Cactus2.gif",
			"images/Plants/Cactus/Attack.gif", "images/Plants/Cactus/Attack2.gif",
			"images/Plants/Cactus/Elongation.gif", "images/Plants/Cactus/Shorten.gif",
	...
	NormalAttack: function() {
		...
		NewImg(c, b.PicArr[8], "left:" + (b.AttackedRX + 25) + "px;top:" + (b.pixelTop + 103) +
			"px;visibility:hidden;z-index:" + (b.zIndex + 2), EDPZ);
		...
		oSym.addTask(1, function(g, i, d, k, h, l) {
			var j, f = GetC(k),
				e = oZ["getZ" + d](k, h);
			e && e.Altitude == 1 ? (e.getPea(e, 30, d), ClearChild(i)) : (k += (j = !d ? 5 : -5)) <
				oS.W && k > 100 ? (i.style.left = (l += j) + "px", oSym.addTask(1, arguments.callee,
					[g, i, d, k, h, l])) : ClearChild(i)
	...
	NormalAttack2: function() {
		...
		NewImg(c, b.PicArr[8], "left:" + (b.AttackedRX + 125) + "px;top:" + (b.pixelTop + 33) +
			"px;visibility:hidden;z-index:" + (b.zIndex + 2), EDPZ);
		...
		oSym.addTask(1, function(g, i, d, k, h, l) {
			var j, f = GetC(k),
				e = oZ["getZ" + d](k, h);
			e && e.Altitude == 3 ? (e.getHit0(e, 20, d), e.Drop(), ClearChild(i)) : (k += (j = !d ?
				5 : -5)) < oS.W && k > 100 ? (i.style.left = (l += j) + "px", oSym.addTask(1,
				arguments.callee, [g, i, d, k, h, l])) : ClearChild(i)
		}, [c, $(c), 0, b.AttackedLX, b.R, b.AttackedLX - 40])
	}
	...
	BookHandBack: 3.5,
	coolTime: 7.5,
	PicArr: ["images/Card/Plants/Oxygen.png", "images/Plants/Oxygen/Oxygen.gif",
	...
	BookHandBack: 2.5,
	coolTime: 30,
	PicArr: ["images/Card/Plants/FlamesMushroom.png", "images/Plants/FlamesMushroom/FlamesMushroom.gif",
	...
	getHurt: function(e, b, a) {
		var c = this,
			d = $(c.id).childNodes[1];
		!(b % 3) ? (c.HP -= a) < 1 ? c.Die() : c.HP < 2667 ? c.HurtStatus < 2 && (c.HurtStatus = 2, d.src =
			"images/Plants/FlamesMushroom/FlamesMushroom2.gif") : c.HP < 5333 && c.HurtStatus < 1 && (c
			.HurtStatus = 1, d.src = "images/Plants/FlamesMushroom/FlamesMushroom1.gif"): c.Die(1)
	},
	//GetDY: function(b, c, a) {
	//    return 6
	//},
	...
	BookHandBack: 2.5,
	SunNum: 25,
	PicArr: ["images/Card/Plants/Plantern.png", "images/Plants/Plantern/Plantern.gif",
	...
	BookHandBack: 3.5,
	SunNum: 0,
	PicArr: ["images/Card/Plants/gun.png", "images/Plants/gun/SeaShroom.gif", "images/Plants/gun/SeaShroom.gif",
		"images/Plants/gun/SeaShroomSleep.gif", "images/Plants/gun/ShroomBullet.gif",
	...
	PrivateBirth: function(a) {
		a.BulletEle = NewImg(0, "images/Plants/gun/ShroomBullet.gif", "left:" + (a.AttackedLX - 46) +
			"px;top:" + (a.pixelTop + 40) + "px;visibility:hidden;z-index:" + (a.zIndex + 2))
	},
	BirthStyle: function(c, d, b, a) {
		EditEle(b, {
	...
	NormalAttack: function() {
		...
		oSym.addTask(1, function(j, d, e, f, g) {
			...
			h && h.Altitude == 1 ? (h.getPea(h, 20, 0), (SetStyle(d, {
				left: g + 38 + "px"
			})).src = "images/Plants/gun/ShroomBulletHit.gif", oSym.addTask(10, ClearChild,
				[d])) : (e += 5) < oS.W ? (d.style.left = (g += 5) + "px", oSym.addTask(1,
				arguments.callee, [j, d, e, f, g])) : ClearChild(d)
		}, [c, $(c), a, b.R, a - 46])
	}
	...
	BookHandBack: 3.5,
	AudioArr: ["SeaAnemone"],
	PicArr: ["images/Card/Plants/SeaAnemone.png", "images/Plants/SeaAnemone/GloomShroom.gif",
		"images/Plants/SeaAnemone/GloomShroom.gif", "images/Plants/SeaAnemone/GloomShroomSleep.gif",
		"images/Plants/SeaAnemone/GloomShroomAttack.gif", "images/Plants/SeaAnemone/GloomShroomBullet.gif"
	],
	AudioArr: ["kernelpult", "kernelpult2"],
	...
	PrivateBirth: function(b) {
		...
		NewEle(a + "_Bullet", "div", "position:absolute;visibility:hidden;width:210px;height:200px;left:" +
			(b.pixelLeft - 60) + "px;top:" + (b.pixelTop - 65) +
			"px;background:url(images/Plants/SeaAnemone/GloomShroomBullet.gif);z-index:" + (b.zIndex +
				1), 0, EDPZ)
	},
	NormalAttack: function() {
		...
		for (g = k.MinR; g <= f; g++) {
			e = oZ.getArZ(c, b, g);
			for (h = e.length; h--;
				(a = e[h]).Altitude < 2 && a.getHit1(a, 101)) {}
		}
		oSym.addTask(100, function(i) {
			PlayAudio(["kernelpult", "kernelpult2"][Math.floor(Math.random() * 2)]);
			--i && oSym.addTask(100, arguments.callee, [i])
	...
	NormalGif: 1,
	AudioArr: ["TTS"],
	PicArr: ["images/Card/Plants/TTS.png", "images/Plants/TTS/Float.gif", "images/Plants/TTS/Float.gif",
		"images/Plants/TTS/Grab.png", "images/Plants/TTS/splash.png"
	],
	...
	NormalAttack: function(a, b) {
		...
		b.beAttacked = 0;
		b.isAttacking = 1;
		NewImg(0, "images/Plants/TTS/Grab.png", "left:" + b.beAttackedPointL + "px;top:" + (b.height - 67) +
			"px", b.Ele);
		oSym.addTask(50, function(g, h) {
			var e = g.id,
				f = h.id,
				...
				c = f + "_splash";
			NewEle(c, "div",
				"position:absolute;background:url(images/Plants/TTS/splash.png);left:" + (h
					.AttackedLX - 10) + "px;top:" + (h.pixelTop + h.height - 88) +
				"px;width:97px;height:88px;over-flow:hidden", 0, EDPZ);
			ImgSpriter(d, e, [
				["0 0", 9, 1],
				["-97px 0", 9, 2],
	...
	BookHandBack: 2.5,
	AudioArr: ["Magneticmu"],
	PicArr: ["images/Card/Plants/MagneticmuShroom.png", "images/Plants/MagneticmuShroom/0.gif",
		"images/Plants/MagneticmuShroom/Shrubbery.gif", "images/Plants/MagneticmuShroom/ShrubberyBoom.gif" +
		$Random
	],
		...
		oSym.addTask(10, function(j) {
			...
			if (h) {
				...
				var b = $(j),
					...
					d = oGd.$Crater;
				while (e--) {
					if (c[e].EName == 'oBucketheadZombie' || c[e].EName == 'oFootballZombie' || c[e]
						.EName == 'oHeiFootballZombie' || c[e].EName == 'oCFootballZombie' || c[e]
						.EName == 'oScreenDoorZombie' || c[e].EName == 'oDuckyTubeZombie3' || c[e]
						.EName == 'oDuckyTubeZombie4' || c[e].EName == 'oSmallFootballZombie' || c[
							e].EName == 'oCBucketheadZombie' || c[e].EName == 'oTrashZombie' || c[e]
						.EName == 'oCFootballZombie' || c[e].EName == 'oConeheadZombie' || c[e]
						.EName == 'oCConeheadZombie' || c[e].EName == 'oJY' || c[e].EName ==
						'oBalloonZombie' || c[e].EName == 'oNewspaperZombie' || c[e].EName ==
						'oCNewspaperZombie' || c[e].EName == 'oDuckyTubeZombie2') {
						c[e].OrnHP = 0;
						c[e].getHit0(c[e], 0, 0);
					}
				}
	...
	coolTime: 30,
	HP: 4000,
	PicArr: ["images/Card/Plants/LaserBean.png", "images/Plants/LaserPea/0.gif",
		"images/Plants/LaserPea/LaserPea.gif", "images/Plants/LaserPea/LaserPeaSleep.gif",
		"images/Plants/LaserPea/LaserPeaAttack.gif", "images/Plants/LaserPea/LaserPeaBullet.gif"
	],
	AudioArr: ["LaserBean"],
	...
	PrivateBirth: function(b) {
		...
		NewEle(a + "_Bullet", "div", "position:absolute;visibility:hidden;width:343px;height:62px;left:" + b
			.AttackedRX + "px;top:" + (b.pixelTop + 5) +
			"px;background:url(images/Plants/LaserPea/LaserPeaBullet.gif);z-index:" + (b.zIndex + 1), 0,
			EDPZ)
	},
	PrivateDie: function(a) {
		ClearChild($(a.id + "_Bullet"))
