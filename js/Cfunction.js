var $User = function() {
		...
		e ? (document.execCommand("BackgroundImageCache", false, true), ShadowPNG = "") : ShadowPNG =
			"images/interface/plantshadow32.png";
		return {
			Browser: {
				IE: c,
				IE6: e,
	...
	oS = {
		...
		Init: function(e, g, b, d) {
			...
			$User.isAuthorWebsite && oS.LevelEName != 0 && (ClearChild($("JSPVZAjax")), NewEle("JSPVZAjax",
				"script", 0, {
		...
		LoadTips: function() {
			var b = NewEle("dTips", "div",
					"position:absolute;color:#fff;top:450px;width:100%;text-align:center;font-size:16px", "", EDAll
				),
				a = [""];
			b.innerHTML = '<span style="font-weight:bold"></span><span>' + a[Math.floor(Math.random() * a.length)] +
				"</span>"
		},
		LoadProgress: function(r, l, a, t, b) {
			...
			switch (p.Coord) {
				case 2:
					NewImg(0, "images/interface/PoolCleaner.png", "", $Pn.oPoolCleaner = NewEle(0, "div",
						"position:absolute"));
				case 1:
					NewImg(0, "images/interface/LawnCleaner.png", "", $Pn.oLawnCleaner = NewEle(0, "div",
						"position:absolute"));
					break
			}
			while (r--) {
		...
		LoadScript: $User.Browser.IE ?
			function(f, c, e, a, d) {
				...
				b.onreadystatechange = function() {
					(b.readyState == "loaded" || b.readyState == "complete") && (b.onreadystatechange = null, e(d,
						1))
				};
				b.onerror = function() {
		...
		LoadReady: function(f) {
			...
			$("dFlagMeter").style.marginTop = "245px";
		...
		ScrollScreen: function() {
			(EDAll.scrollLeft += 25) < 500 ? oSym.addTask(2, arguments.callee, []) : (DisplayZombie(), SetVisible($(
				"dMenu")), oS.CanSelectCard ? SetVisible($("dTop"), $("dSelectCard"), $("dCardList")) : (
		...
		ScrollBack: function(a) {
			...
			(function(c) {
				...
				(b -= 25) > 0 ? (EDAll.scrollLeft = b, oSym.addTask(2, arguments.callee, [c])) : (EDAll
					.scrollLeft = 0, c())
			})(a)
		}
	},
	oCoord = {
		1: function() {
			...
			GetC = function(a) {
				return $SSml(a, [-50, 100, 140, 220, 295, 379, 460, 540, 625, 695, 775, 855, 935], [-2, -1, 0,
	...
	oP = {
		Init: function(a) {
			...
			a && a.FlagNum ? (r.FlagHeadStep = Math.floor(140 / (a.FlagNum - 1)), r.MonPrgs = function() {
				var u = oP,
					j, i = u.FlagZombies,
					s, t, f = $User.Visitor;
				!--u.NumZombies && (i < u.FlagNum ? (u.ReadyFlag = ++i, oSym.addTask(500, u.FlagPrgs, [])) :
					(u.FlagToEnd(), $User.isAuthorWebsite && $User.Visitor.UserName != "" && (
						ClearChild($("JSPVZAjax")), f.SaveLvl && NewEle("JSPVZAjax", "script",
							0, {},
					...
					}), !isNaN(Math.floor(s)) && (t = $("dAdventure"), $User.Visitor.Progress = ++s,
						t.firstChild.innerHTML = Math.ceil(s / 10), t.childNodes[1].innerHTML = (s =
							s - Math.floor(s / 10) * 10) ? s : s + 1), NewEle("DivA", "div",
						"position:absolute;width:900px;height:600px;background:#FFF;filter:alpha(opacity=0);opacity:0;z-index:255",
						0, EDAll), PauseGame($("dMenu0"), 1)))
			}) : r.MonPrgs = function() {};
		...
		SelectFlagZombie: function(j, d) {
			var e = oP,
				...
				c = false,
				h = !n ? 150 : (PlayAudio("siren"), n.style.top = "5px", --j, i[g++] = oS.FlagZombie || oFlagZombie,
					30),
				p,
				b,
				f = e.MustShowAtFlag,
		...
		SetTimeoutWaterZombie: function(j, b, e, h) {
			...
			c = e;
			while (c--) {
				k[c] = (m[c] = new h[Math.floor(Math.random() * g)]).CustomBirth(l[Math.floor(Math.random() * a)],
		...
		FlagPrgs: function() {
			var f = oP,
				...
				d = $SSml(c, e.a1, e.a2),
				b;
			f.FlagNum > (c = ++f.FlagZombies) ? ($("imgFlagHead").style.left = a + "px", $("imgFlagMeterFull").style
				.clip = "rect(0,157px,21px," + (a + 11) + "px)", (b = $SEql(c, f.FlagToMonitor)) && oSym
				.addTask(1690,
					function(g) {
						!g[1] && (g[0](), g[1] = 1)
					},
					...
					[c])) : ($("imgFlagHead").style.left = "-1px", $("imgFlagMeterFull").style.clip =
				"rect(0,157px,21px,0)");
	...
	oGd = {
			...
			var d = "",
				...
				e = (function() {
					return function(f) {
						...
						d += '<img id="' + f + '" src="images/interface/fog' + Math.floor(Math.random() *
								4) + "." + (h ? "gif" : "png") + '" style="left:' + g + "px;top:" + tx +
							'px">'
					}
				})();
		...
		MoveFogLeft: function(a) {
			(function(c, d, b, e) {
				d -= 50;
				d > b ? (c.style.left = d + "px", oSym.addTask(5, arguments.callee, [c, d, b, e])) : (c.style
					.left = b + "px", e && e())
		...
		MoveFogRight: function() {
			if (arguments.callee.caller.caller == null) {
				...
				(b += 50) < 901 ? (a.style.left = b + "px", oSym.addTask(5, arguments.callee, [a, b])) : a.style
					.left = "900px"
	...
	GetAP = function(a, h, d, c) {
		var f, i = oGd.$,
			e, g = [],
			b;
		for (f = 0; f < 4; g.push(e = i[d + "_" + c + "_" + f++]), e && !(a < e.pixelLeft || a > e.pixelRight || h < e
				.pixelTop || h > e.pixelBottom) && (b = e)) {}
		return [g, b]
	},
	...
	DisplayZombie = function() {
		...
		while (b) {
			...
			g.CanDisplay ? (d.splice(a, 1), e[b--] = g.getHTML("", Math.floor(50 + Math.random() * 201) - g.width * 0.5,
				f[b] - g.height, 1, "block", "auto", g.GetDTop, g.PicArr[g.StandGif])) : --b
		}
	...
	InitPCard = function() {
		...
		while (b < a) {
			...
			d += '<div class="span1" id="Card' + EName +
				'" onmouseout="SetHidden($(\'dTitle\'))" onmousemove="ViewCardTitle(' + EName +
				',event)" onclick="SelectCard(\'' + EName + '\')"><img src="' + c.PicArr[0] + '"><span class="span2">' +
				c.SunNum + "</span></div>";
			b++ % 6 == 5 && (d += "<br>")
		}
		$("dPCard").innerHTML = d
	...
	InitHandBookPCard = function() {
		...
		var d = "",
			g, f, e = [oPeashooter, oSunFlower, oCherryBomb, oWallNut, oPotatoMine, oSnowPea, oChomper, oRepeater,
				oPuffShroom, oSunShroom, oFumeShroom, oGraveBuster, oHypnoShroom, oScaredyShroom, oIceShroom,
				oDoomShroom, oLilyPad, oSquash, oThreepeater, oTangleKlep, oJalapeno, oSpikeweed, oTorchwood, oTallNut,
				oCactus, oPlantern, oSplitPea, oStarfruit, oPumpkinHead, oFlowerPot, oCoffeeBean, oGarlic, oSeaShroom,
				oOxygen, ostar, oTTS, oGun, oSeaAnemone, oGatlingPea, oGloomShroom, oTwinSunflower, oSpikerock,
				oTenManNut, oSnowRepeater, oLing, oLotusRoot, oMagneticmuShroom, oLaserBean, oBigChomper,
				oFlamesMushroom
			],
			a = e.length,
			b = 0,
		...
		while (b < a) {
			...
			c = g.prototype;
			f = c.EName;
			d += '<div class="span1" onclick="ViewProducePlant(' + f + ')"><img src="' + c.PicArr[0] +
	...
	InitHandBookZCard = function() {
		PlayAudio("gravebutton");
		var d = "",
			g, f, e = [oZombie, oConeheadZombie, oPoleVaultingZombie, oBucketheadZombie, oFlagZombie, oNewspaperZombie,
				oScreenDoorZombie, oFootballZombie, oHeiFootballZombie, oDancingZombie, oBackupDancer,
				oDuckyTubeZombie1, oSnorkelZombie, oZomboni, oDolphinRiderZombie, oBalloonZombie, oJackinTheBoxZombie,
				oImp, oCZombie, oCConeheadZombie, oCBucketheadZombie, oEunZombie, othugZombie, oZZ, oEmperor, oCXZombie,
				oXBZombie, oJX, oJY, oLGBOSS, oWarshipsZombie, oSubZombie, oWJY, oMustacheZombie, oTrashZombie,
				oLionDanceZombie
			],
			a = e.length,
			b = 0,
		...
		while (b < a) {
			...
			c = g.prototype;
			f = c.EName;
			d += '<div class="span1" onclick="ViewProduceZombie(' + f + ')"><img src="' + c.PicArr[0] +
				'"><div class="span2">' + c.SunNum + "</div></div>";
			b++
		}
	...
	ViewProduceZombie = function(b) {
		PlayAudio("plant1");
		var a = b.prototype;
		$("pHandBookZombie").style.background = "url(" + a.PicArr[a.StaticGif] + ") no-repeat scroll " + a
			.BookHandPosition;
	...
	ViewCardTitle = function(b, c) {
		...
		var f = $("dTitle"),
			a = b.prototype;
		f.innerHTML = a.CName + "<br>冷却时间:" + a.coolTime + "秒<br>" + (oS.DKind && a.night ?
			'<span style="color:#F00">夜行性的--在白天会睡觉</span><br>' + a.Tooltip : a.Tooltip || (
	...
	SelectCard = function(c) {
		...
		if (!b.Select) {
			...
			oS.StaticCard && (g = NewEle("dCard" + c, "div", "", {
				...
				$("dCardList")), NewImg(0, f.src, "width:100px;height:120px", g), innerText(NewEle("sSunNum" +
				c, "span", 0, 0, g), i.SunNum), f.style.top = "-42px")
		} else {
			b.Select = 0;
	...
	ViewPlantTitle = function(b) {
		var f = $("dTitle"),
			...
			c = e.PName.prototype,
			a = c.CName;
		!oS.CardKind && (a += "<br>冷却时间:" + c.coolTime + "秒<br>" + c.Tooltip, !e.CDReady && (a +=
			'<br><span style="color:#F00">正在重新装填中...</span>'));
	...
	MonitorCard = function(d) {
		...
		if (oS.Chose < 1) {
			while (b--) {
				(c = (d = ArCard[b]).PName.prototype).SunNum > oS.SunNum ? (d.SunReady && (d.SunReady = 0), $(d.DID)
					.childNodes[0].style.top = "-60px") : (!d.SunReady && (d.SunReady = 1), d.CDReady && ($(d.DID)
					.childNodes[0].style.top = 0))
			}
		} else {
			while (b--) {
				(c = (d = ArCard[b]).PName.prototype).SunNum > oS.SunNum ? d.SunReady && (d.SunReady = 0) : !d
	...
	DoCoolTimer = function(c, b) {
		...
		(function(d, e) {
			d > 0 ? (innerText($("dCD1" + e), d), innerText($("dCD2" + e), d), oSym.addTask(50, arguments.callee, [(
				d - 0.5).toFixed(1), e])) : (ClearChild($("dCD1" + e), $("dCD2" + e)), ArCard[e].CDReady = 1,
				MonitorCard())
		})(b, c)
	},
	ChosePlant = function(h, d) {
		...
		var b = h.clientX - EDAlloffsetLeft + EBody.scrollLeft || EElement.scrollLeft,
			...
			f, c = j.PicArr;
		oS.Chose = 1;
		!oS.CardKind ? EditImg(NewImg("MovePlant", c[j.StaticGif], "left:" + b - 0.5 * (j.beAttackedPointL + j
				.beAttackedPointR) + "px;top:" + a + 20 - j.height + "px;z-index:254", EDAll).cloneNode(false),
			"MovePlantAlpha", "", {
				visibility: "hidden",
			...
			EDAll) : (NewImg("MovePlant", j.PicArr[j.StandGif], "left:" + (b - 0.5 * (j.beAttackedPointL + j
			.beAttackedPointR)) + "px;top:" + (a + 20 - j.height) + "px;z-index:254", EDAll), NewImg(
			"MovePlantAlpha", j.PicArr[j.StandGif],
			"visibility:hidden;filter:alpha(opacity=40);opacity:0.4;z-index:30", EDAll));
		while (e--) {
	...
	ChoseShovel = function(a) {
		PlayAudio("shovel");
		WhichMouseButton(a) < 2 && (SetHidden($("imgShovel")), NewImg("tShovel", "images/interface/Shovel/0.gif",
			"left:" + (a.clientX - 10) + "px;top:" + (a.clientY + document.body.scrollTop - 17) +
			"px;z-index:1", EDAll), oS.Chose = -1, GroundOnmousemove = GroundOnmousemove2, StopBubble(a))
	},
	...
	GrowPlant = function(l, d, c, e, b) {
		var j = oS.ChoseCard,
			...
			a,
			g = oGd.$LF[e];
		k.CanGrow(l, e, b) && (PlayAudio(g != 2 ? "plant" + Math.floor(1 + Math.random() * 2) : "plant_water"), !oS
			.CardKind ? (new h).Birth(d, c, e, b, l) : asyncInnerHTML((a = new h).CustomBirth(e, b, 0, "auto"),
				function(n, m) {
					EDPZ.appendChild(n);
					m.Birth()
				},
				a), innerText(ESSunNum, oS.SunNum -= k.SunNum), i && (f.CDReady = 0, DoCoolTimer(j, k.coolTime)),
		...
		a ? (d = 0, oSym.addTask(10, MoveDropSun, [g, f])) : (d = f - b - 20, c += ";top:" + d + "px", oSym.addTask(1,
			function(q, p, n, j, l, k, m, i) {
				if (ArSun[q] && ArSun[q].C) {
					...
					l.shift();
					--m;
					m > 0 && ((l.length == 0) && (l = [8, 16, 24, 32]), oSym.addTask(i, arguments.callee, [q, p,
						n, j, l, k, m, ++i
					]))
				}
			},
		...
		(function(k, l, n, s, m, r, j, q, p) {
			(m -= q) > n ? (SetStyle($(k), {
				...
				top: (r -= p) + "px"
					...
					left: n + "px",
					top: s + "px"
				}), Number(ESSunNum.innerHTML) != oS.SunNum && (oS.SunNum = Math.min(Number(ESSunNum.innerHTML),
					oS.SunNum)), innerText(ESSunNum, oS.SunNum = Math.min(oS.SunNum + l.N, 9990)),
				MonitorCard(), delete ArSun[k], oSym.addTask(20, ClearChild, [$(k)]))
		})(b, c, e, i, d, h, 1, g, f)
	},
	...
	ShowLargeWave = function(a) {
		...
		NewImg("LargeWave", "images/interface/LargeWave.gif", "left:71px;top:249px;width:400px;height:200px;z-index:50",
			EDAll);
		oSym.addTask(4,
			function(b, c, d) {
				SetStyle($("LargeWave"), {
	...
	ShowFinalWave = function() {
		var a = function(b) {
			...
			NewImg("FinalWave", "images/interface/FinalWave.gif",
				"left:122px;top:194px;width:756px;height:213px;z-index:50", EDAll);
			oSym.addTask(4,
				function(c, e, d) {
					SetStyle($("FinalWave"), {
						width: (c -= 50.4) + "px",
	...
	ShowBOSS = function(a) {
		PlayAudio("finalwave");
		NewImg("ShowBOSS", "images/interface/BOSSWave.gif", "left:71px;top:249px;width:858px;height:102px;z-index:50",
			EDAll);
		oSym.addTask(4,
			function(b, c, d) {
				SetStyle($("LargeWave"), {
		...
		var b = function() {
			...
			oSym.addTask(60,
				...
				[NewEle(0, "div",
					...
					(oS.W * 0.5 - 77) + "px;top:" + (oS.H * 0.5 - 54) + "px", 0, EDAll), a])
		};
	...
	SelectModal = function(g) {
		...
		SetHidden($("dCardList"), $("tGround"), $("dSelectCard"), $("dTop"), $("dMenu"), $("dHandBook"), $("dNewPlant"),
			$("dProcess"));
	...
	LoadLvl = function(e, c) {
		...
		oSym.Init(function(g, f) {
			...
			[e && b ? 0 : e]);
		// $("aLvlLink").href = "html/2-1" + (e && !isNaN(e) ? "-" + e : "") + ".html"
	},
	AppearTombstones = function(n, e, m) {
		...
		while (m--) {
			...
			k.splice(g, 1);
			a = NewEle("dTombstones" + h + "_" + b, "div", "position:absolute;width:86px;height:91px;left:" + (GetX(b) -
				43) + "px;top:" + (GetY(h) - 91) + "px", 0, EDAll);
	...
	ViewHandBook = function() {
		SetNone($("dOptionsMenuback"), $("dOptionsMenu"));
		oS.Lvl ? (AllAudioPaused(), PlayAudio("gravebutton"), SetNone($("dSurface")), oSym.Stop(), innerText($(
			"dMenu0"), "回到游戏"), $("dMenu1").onclick = null) : (AllAudioPaused(), PlayAudio("tap"));
