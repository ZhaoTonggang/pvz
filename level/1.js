oS.Init({
	...
	PicArr: function() {
		var a = oSunFlower.prototype,
			b = a.PicArr;
		return ["images/interface/SodRollCap.png", "images/interface/SodRoll.png",
			"images/interface/background1unsodded_1.jpg", "images/interface/background1unsodded.jpg", b[
				a.CardGif], b[a.NormalGif]
		]
	}(),
	SunNum: 250,
	...
	LoadAccess: function(a) {
		NewImg("imgSF", "images/interface/tiaoguo.png", "left:5px;top:5px", EDAll, {
			onclick: function() {
				SelectModal(3)
			}
		});
	...
	StartGame: function() {
		EditImg($("imgSF"), 0, "images/interface/tiaoguo.png", {
			left: "570px",
			top: "10px"
		});
		StopMusic();
		...
		(function(e, h, b, d, c, g, a, f) {
			...
			e < 990 ? oSym.addTask(3, arguments.callee, [e, h, b, d, c, g, a, f]) : (ClearChild($(
				"SodRoll_1"), $("SodRollCap_1")), (function() {
				NewEle("DivTeach", "div", 0, 0, EDAll);
				oS.InitLawnMower();
				oP.Monitor({
					ar: [0],
						...
						switch (k) {
							case 0:
								...
								NewImg("PointerUD",
									...
									"top:60px;left:50px", EDAll);
								oSym.addTask(10, arguments.callee, [++k]);
								break;
							case 1:
								i > 0 && (innerText($("DivTeach"),
									"点击草地种下你的种子！"), EditImg($(
										"PointerUD"), "",
							...
							case 2:
								...
								break;
							case 3:
								oS.SunNum > 99 && (innerText($("DivTeach"),
									"点击豌豆射手，再种一棵！"), EditImg($(
										"PointerUD"), "",
									"images/interface/PointerUP.gif", {
										left: "50px",
							...
							default:
								...
								j > 0 ? (SetHidden($("PointerUD")), innerText($(
											"DivTeach"), "别让僵尸靠近你的房子！"), oP
										.AddZombiesFlag(), oSym.addTask(500,
											SetNone, [$("DivTeach")])) : oSym
									.addTask(10, arguments.callee, [4])
						}
					}
				});
				BeginCool();
	...
	FlagToEnd: function() {
		NewImg("imgSF", "images/Card/Plants/SunFlower.png",
