oS.Init({
	...
	PicArr: function() {
		...
		return ["images/interface/SodRollCap.png", "images/interface/SodRoll.png",
			"images/interface/background1unsodded2.jpg", "images/interface/background1unsodded_1.jpg",
			b[a.CardGif], b[a.NormalGif]
		]
	}(),
	...
	StartGame: function() {
		NewImg("imgSF", "images/interface/tiaoguo.png", "left:570px;top:10px", EDAll, {
			onclick: function() {
				SelectModal(3)
			}
		});
