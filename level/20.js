oS.Init({
	...
	ZName: [oZombie, oZombie2, oZombie3, oConeheadZombie, oDancingZombie, oScreenDoorZombie, oFootballZombie,
		oBackupDancer, oBucketheadZombie
	],
	PicArr: ["images/interface/background2.jpg", "images/interface/trophy.png",
		"images/interface/Tombstones.png", "images/interface/Tombstone_mounds.png"
	],
			...
			oP.Monitor({
				...
				function(a) {
					oP.FlagNum == oP.FlagZombies && oP.SetTimeoutTomZombie([oZombie,
						oConeheadZombie, oBucketheadZombie
					])
				});
			oP.AddZombiesFlag();
	...
	FlagToEnd: function() {
		NewImg("imgSF", "images/Card/Plants/LilyPad.png",
