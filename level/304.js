oS.Init({
	PName: [oFlowerPot, oThreepeater, oCherryBomb, oTenManNute, oJalapeno, oSquash, oGatlingPea, oSnowRepeater,
		oPumpkinHead, oChomper, oRepeater
	],
	ZName: [oZombie, oZombie2, oZombie3, oConeheadZombie, oPoleVaultingZombie, oWJY, oJackinTheBoxZombie,
		oBucketheadZombie, oMustacheZombie
	],
	PicArr: ["images/interface/djtls.jpg", "images/interface/trophy.png"],
	backgroundImage: "images/interface/djtls.jpg",
	CanSelectCard: 0,
	LF: [0, 1, 3, 3, 1, 1],
	LevelName: "大教堂（绿地）--第2夜",
	LvlEName: 0,
	LargeWaveFlag: {
		10: $("imgFlag3"),
		30: $("imgFlag1")
	...
	FlagToSumNum: {
		...
		a2: [32, 128, 200, 200, 400, 600, 300, 500, 900, 1200, 2000, 1, 1, 3000]
	},
	FlagToMonitor: {
		9: [ShowLargeWave, 0],
		29: [ShowFinalWave, 0]
