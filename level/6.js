oS.Init({
	...
	PicArr: function() {
		var a = oSnowPea.prototype,
			b = a.PicArr;
		return ["images/interface/background1.jpg", "images/interface/crater1.png", b[a.CardGif], b[a
			.NormalGif]]
	}(),
	...
	FlagToEnd: function() {
		NewImg("imgSF", "images/Card/Plants/SnowPea.png", "left:80%;top:52%;clip:rect(auto,auto,60px,auto)",
			EDAll, {
				onclick: function() {
