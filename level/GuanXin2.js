oS.Init({
	PName: [oStarfruit],
	ZName: [oZombie, oZombie2, oZombie3, oConeheadZombie, oBucketheadZombie, oScreenDoorZombie,
		oHeiFootballZombie, oBackupDancer, oDancingZombie
	],
	...
	FlagToSumNum: {
		...
		a2: [1, 2, 3, 8, 4, 5, 18, 15, 32, 32, 36, 99]
	},
	FlagToMonitor: {
		29: [ShowFinalWave, 0]
	},
